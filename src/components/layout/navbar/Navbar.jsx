  ...
  return (
    <div className="flex flex-row justify-around items-center ">
      ...
      <div className="bigmenu flex flex-row justify-evenly w-1/2 items-center gap-2 flex-nowrap">
          ...
          <a href="#" className=" whitespace-nowrap bg-blue-500 text-white p-4 rounded-md mt-2  ">تسجيل الدخول</a>
          <a href="#" className="whitespace-nowrap border-2 border-blue-500 rounded-md p-3 mt-2"> دخول</a>
